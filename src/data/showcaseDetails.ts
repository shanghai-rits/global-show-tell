...
export const showcaseDetails: ShowcaseDetailItem[] = [
  {
    id: 1,
    ...
    sections: {
      'How AI Is Used in This Project': `The Live-Diffusion project focuses on developing a real-time interactive AI-generated image system. By leveraging sensor and camera data, the system dynamically responds to user interactions, enhancing creative expression through AI-generated imagery. Integrating platforms like TouchDesigner and ComfyUI, the project emphasizes real-time interactivity and customizability, aiming to create a more inclusive and intuitive environment for creators. The system's design allows for flexible user inputs and is intended to encourage broader participation in AI-driven creative processes.`,
      Interactivity: `To realize real-time interactive AI image generation, the system shall:
...
We believe that AI is not something that artists and creatives should fear, but rather as a tool for achieving our own creative potentials. We do not believe that AI will replace music creators because the core of music as an expression is innately human, dating back to the Prehistoric Eras. We hope to demonstrate that music streaming and consumption is no longer limited to the major streaming platforms, which value capital over artistry and technology over people. We acknowledge that this is still a nascent field, and that this project is not perfect, but we hope that it sparks some inspiration in other artists to think critically about their use of technology and how the distribution of their work contributes towards their goals and values.`,
    ...
    detailVideos: [
      { src: 'https://drive.google.com/file/d/1uCJM3Ju77UzJ0GKaZzCpTPC5KrwqAVeM/preview', width: 550 },
  ...
  },
  {
    ...
    sections: {
      'How AI Is Used in This Project': `Our project incorporates AI through neuroevolution, a machine learning approach that combines genetic algorithms with neural networks. By simulating natural selection, the system continuously refines its neural network, creating an ever-evolving, responsive digital entity.`,
      Interactivity: `Our project explores the dynamic relationship between digital and biological life by creating a digital life form that observes and mimics evolutionary behaviors found in nature. It interacts directly with biological organisms, learning from their survival strategies and adapting over time.
...
Code (well-trained version): https://editor.p5js.org/lindashao1220/sketches/v8odc0gwf`,
    ...
    detailImages: [{ src: '/showcase/4/1.jpg', width: 800 }],
  },
  {
    id: 5,
    title: 'Dear Diary',
    ...
    sections: {
      'How AI Is Used in This Project': `The texts that the printer prints out are generated by a GPT 4o model fine-tuned with diary entries I wrote. Each text produced by the Large Language model presents a unique narration, sounds like what I might write, incorporates my experience, but is never one of my days. `,
      Interactivity: `The project board features six emotional zones: Happy, Confused, Fearful, Excited, Stressful, and ??? (emotion with question marks). Participants place stones in the different emotional zones, with the weight of the stones in each zone representing the intensity of that emotions in their heart. The printer prints out diary entries every 30 seconds based on the emotion inputs on the board, producing texts that mirror what I might write under those emotional intensities.`,
      'The Global Learning Story': `I built Dear Diary in Fall 2024, as the final project for the Machine Learning for Artists and Designers class. Professor Gottfried Haider, as the instructor of the class, expands my thinking in combining AI with different media. He trusts me in coming up a good projects idea, when I felt anxious in finding what I want to build. He also offers great technical support. What felt out of my reach became achievable under his guidance. 
...
https://rivawang.cargo.site/silhouette-of-life`,
    sections: {
      'How AI Is Used in This Project': `AI tools are used in the process of creating images and videos to project on the fabrics.`,
      Interactivity: `The projection videos are made using AI tools to transform original painting and our preferred artistic style into separate videos.`,
      'The Global Learning Story': `We are encouraged by our classmates and professors to create a tangible installation for better audience engagement, rather than something purely digital.`,
    },
    coverImage: '/showcase/6/cover.jpg',
    detailImages: [{ src: '/showcase/6/1.png', width: 800 }],
    detailVideos: [
...
https://coryleeart.com/Poespin-Wherever-your-body-reach-there-is-a-poetry`,
    sections: {
      'How AI Is Used in This Project': `PoeSpin is a human-AI cocreating writting system that transforms ‘pole dancing’ movements into poetry, blending Eastern and Western artistic traditions. Our project uses three innovative approaches:
...
`,
      'The Global Learning Story': `My friend Wendy Li (pole dancer in poespin) and our professor Allison Parrish`,
      'Video Documentation': `https://www.youtube.com/watch?v=yitrzUpIYq4`,
...
https://whyjq.com/arrival/`,
    sections: {
      'How AI Is Used in This Project': `I used AI as "translation" for the conversation with the alien. The language of the aliens are hardcoded with the parameters of the user input, making it mysterious. AI's role here makes the figure of the alien more vivid and interesting.`,
      Interactivity: `Users can talk to the alien by typing their messages or choose the questions in the example bar. Aliens will reply with their own unique language and will be translated.`,
      'The Global Learning Story': `The original movie "Arrival". It is a very interesting narrative about how people firstly meet the aliens in the condition that they barely understand each other.`,
...
The introduction and entry point to the project: https://whyjq.com/?code=4001"`,
    ...
    detailImages: [{ src: '/showcase/9/1.png', width: 800 }],
  },
  {
    id: 10,
...
enables performers, artists, and collaborators to visualize light as a creative
...
These two systems create a feedback loop where users—regardless of technical background—can design, experiment, and communicate lighting ideas more intuitively than ever before.`,
      'The Global Learning Story': `This project was supported by the Integrated Design & Media (IDM) program at NYU Tandon, where I explored the intersection of performance, technology, and interaction design. Special thanks to Professor Scott Fitzgerald, whose feedback and guidance helped me shape the conceptual and technical direction of GeneLight. `,
...
https://itp.nyu.edu/lowres/thesisarchive2024/?liyanbing-he`,
    sections: {
      'How AI Is Used in This Project': `I integrated AI into my project by providing it with several possible script directions and asking it to evaluate the narrative flow. The AI helped assess the potential audience reactions to different scenarios and tested the effectiveness of the interactive choices I designed.`,
...
So, If the people think in different languages, what gets lost - not just the sentence itself, but cognitively and philosophically? When we rely on translation? And how does that loss affect connection, identity, and creativity?`,
  ...
  },
  {
    ...
    sections: {
      'How AI Is Used in This Project': `This project uses ml5’s body pose capture model to track the user’s movement in real time. Mapping each joint to different visual elements.`,
  ...
  },
  {
    ...
    sections: {
      'How AI Is Used in This Project': `I used ml.js to realize hand-tracking interactions of grabbing and releasing.`,
...
Every person carries an inner universe shaped by thoughts, emotions, and experiences. This world is uniquely their own, intimate, invisible, and often unnoticed. Sentimental Galaxy gives this hidden universe a visible form. The galaxy becomes a fragment of your inner world, no longer distant or untouchable, but responsive and alive. By reacting to expressions of happiness, sadness, or neutrality it reveals how even subtle shifts on the surface reflect the deeper movements within.`,
    sections: {
      'How AI Is Used in This Project': `This project integrates AI through ml5.js facial recognition, which detects the viewer’s emotional state—happiness, neutrality, or sadness—based on their facial expressions. The detected emotion drives changes in the galaxy’s appearance, such as its color palette and starry dynamics, creating a responsive and immersive environment.`,
