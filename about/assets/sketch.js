...
class Ball {
    constructor() {
        ...
        this.forceRadius = 120; //radius of force sphere
    }
    ...
    update() {
        ...
        if(distance < this.forceRadius && distance > 0){
            ...
            this.velocity.x += pushDirection.x * 0.8;
            this.velocity.y += pushDirection.y * 0.8;
        }
...
function setup() {
    ...
    //adjust gradientCount
    gradientCount = floor(windowWidth / 150);
    // print(windowWidth);
    // print(gradientCount);
    ...
    // Create bubbles
    bubbleCount = floor(gradientCount * 0.7);
